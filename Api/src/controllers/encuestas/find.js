...
const tipoContratosRepository = require('../../repositories/encuestas');
...
async function handler(req, res, next) {
    try {
        ...
        //find
        let response = await tipoContratosRepository.find({ findObject });
        ...
        //Response Object
        let oResponse = {
            tipoContratos: response.tipoContratos
        }
